...
css: |-
  ...
  h2 { margin-top: 12px; margin-bottom: 6px; font-size: 14px; }
  h3 { margin-top: 10px; margin-bottom: 4px; font-size: 12px; }
  p { margin: 4px 0; }
...
### pdf_options Parameters

| Parameter | Description | Values |
|-----------|-------------|--------|
| `margin` | Page margins | `10mm`, `15mm`, `25mm` |
| `format` | Page format | `A4`, `Letter` |
| `printBackground` | Print background | `true` / `false` |
...
PDF is created in the same directory with the same name:
