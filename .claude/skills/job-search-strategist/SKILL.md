...
## Job Search Platforms & Sources

### Primary Global Platforms

| Platform | Best For |
|----------|----------|
| **LinkedIn** | Universal, networking, job applications |
| **Indeed** | High volume, diverse industries |
| **Glassdoor** | Research + jobs, salary data |
| **Otta.com** | IT/Tech roles specifically |

**Note**: Job title naming varies by location. Local language postings may require local language skills.

### Freelance & Contract Work

| Platform | Focus |
|----------|-------|
| **Toptal** | Top-tier freelancers, vetted |
| **Upwork** | Broad freelance marketplace |

**Tip**: First global experience is often easier to get through freelance/contract work.

### Remote Work Platforms

| Platform | Description |
|----------|-------------|
| **Wellfound** (AngelList) | Startup jobs, often remote |
...
- "Remote" / "Full Remote" / "Fully Remote"
- "Remote from anywhere"
- "Work from home"
- "No office attendance required"
- "Flexible location"
- "Distributed team"
- "100% remote"
...
- hh.ru
- LinkedIn
- Telegram channels (Geekjob.ru lists 25+ IT channels)

**International Startups**:
- Failory.com — startups sorted by country
- International companies with Eastern European roots often hire from the region

### Research Tips

- Use ChatGPT to find region-specific job boards
- Ask ChatGPT for job title variations in target region
- Many local markets have their own job sites (900+ job boards exist globally)
...
Networking is about building relationships, not asking for jobs. The formula:
1. Find strategic contacts
2. Say "thank you"
3. Stay engaged
4. Receive opportunities

### "Network-Thanks" Technique

**Step-by-step**:
1. **Discover**: Heard someone at conference, podcast, read their article
2. **Find**: Locate them on LinkedIn and/or Facebook
3. **Connect**: Add to contacts AND write a thank-you message

**Important**: Don't just add — always write a message!

### Thank-You Message Structure

```
1. [Context: where you found them]
   "Hi Kira! I listened to your podcast."

2. [Gratitude]
   "Thank you so much for what you do!"

3. [Specific example of what you liked]
   "The episode about salary negotiations was especially useful.
   Everything you said was spot-on, especially about..."
```

### Mindset Shift

**Wrong mindset**: "Who am I? Nobody needs my thanks."

**Right mindset**: "People love hearing gratitude. It matters. It's needed."

### Permanent Networking Formula

1. **Find and record** contact on LinkedIn
2. **Add and thank**: Send thank-you message
3. **Stay engaged**: Likes, comments, messages, Zoom coffee, meetings, congratulations
   - Like what you genuinely like
   - Comment meaningfully (phrases, not just "Great!")
   - Write thoughtful comments
4. **Create your content** to warm up your contacts
   - Warm contacts are loyal to more complex requests
   - Warm contacts may remember you when they have openings
5. **Receive**: Jobs, partnership offers, projects, professional brand visibility

### Engagement Best Practices

| Do | Don't |
|----|-------|
| Like genuinely interesting posts | Like randomly for visibility |
| Comment with substance (at least a sentence) | Comment just "Great!" or "Like" |
| Share insights related to your expertise | Spam promotional content |
| Congratulate on achievements | Be transactional in every message |
| Ask for informational chats first | Ask for jobs immediately |
